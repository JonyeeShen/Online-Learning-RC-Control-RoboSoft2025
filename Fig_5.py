...
reference_signal = np.ones_like(time)
reference_signal[:5*200] = 0.
...
ax1.plot(time[:plot_span]*sample/1000, mean_outputs_pd[:plot_span], label='PD', color='orange', linewidth=1)
ax1.fill_between(time[:plot_span]*sample/1000, (mean_outputs_pd-std_outputs_pd)[:plot_span], (mean_outputs_pd+std_outputs_pd)[:plot_span], color='orange', alpha=0.2, edgecolor='none')

ax1.plot(time[:plot_span]*sample/1000, mean_outputs_linear[:plot_span], label='Linear+PD', color='green', linewidth=1)
ax1.fill_between(time[:plot_span]*sample/1000, (mean_outputs_linear-std_outputs_linear)[:plot_span], (mean_outputs_linear+std_outputs_linear)[:plot_span], color='green', alpha=0.2, edgecolor='none')
...
ax2.plot(time[:plot_span]*sample/1000, (reference_signal-mean_outputs_pd)[:plot_span], label='PD', color='orange', linewidth=1)
ax2.fill_between(time[:plot_span]*sample/1000, (reference_signal-mean_outputs_pd-std_outputs_pd)[:plot_span], (reference_signal-mean_outputs_pd+std_outputs_pd)[:plot_span], color='orange', alpha=0.2, edgecolor='none')

ax2.plot(time[:plot_span]*sample/1000, (reference_signal-mean_outputs_linear)[:plot_span], label='Linear+PD', color='green', linewidth=1)
ax2.fill_between(time[:plot_span]*sample/1000, (reference_signal-mean_outputs_linear-std_outputs_linear)[:plot_span], (reference_signal-mean_outputs_linear+std_outputs_linear)[:plot_span], color='green', alpha=0.2, edgecolor='none')

ax2.plot(time[:plot_span]*sample/1000, (reference_signal - mean_outputs_esn)[:plot_span], label='ESN+PD', color='red', linewidth=1)
ax2.fill_between(time[:plot_span]*sample/1000, (reference_signal-mean_outputs_esn-std_outputs_esn)[:plot_span], (reference_signal-mean_outputs_esn+std_outputs_esn)[:plot_span], color='red', alpha=0.2, edgecolor='none')
...
ax1.xaxis.set_tick_params(direction='in', top=True)
ax1.yaxis.set_tick_params(direction='in', right=True)
ax1.spines['top'].set_visible(True)
ax1.spines['right'].set_visible(True)

ax2.xaxis.set_tick_params(direction='in', top=True)
