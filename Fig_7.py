...
def generate_lorenz63(timesteps, dt=0.01):
    init_state = [17.67715816276679, 12.931379185960404,23.91404334248268]
    t_span = [0, timesteps * dt]
    t_eval = np.arange(0, timesteps * dt, dt)
    solution = solve_ivp(lorenz63, t_span, init_state, t_eval=t_eval)
    return solution.y
...
lorenz_data = generate_lorenz63(duration*sample, 1/sample)
reference_signal = lorenz_data[2]
